...
const experience: ExperienceEntry[] = [
  {
    ...
    clusters: [
      ...
      },
      {
        ...
        synopsis:
          'I review more code than I write — 208 pull requests reviewed against 134 authored, across six repositories. I also lead the weekly operations review, wrote the on-call working agreement that went org-wide inside a quarter, and take the release rotation as Release Engineer of record.',
        paragraphs: [
